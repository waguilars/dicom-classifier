...
int main() {
  ...
  std::cout << "Score " << GetIrisScore(classifier) << std::endl;
   ...
   float p1 = classifier.predict({5.1, 3.5, 1.4, 1.2});
   float p2 = classifier.predict({5.4, 3.9, 1.3, 0.4});
   float p3 = classifier.predict({ 6.8, 3.2, 5.9, 2.3 });
