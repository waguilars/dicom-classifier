...
face = imageio.imread('img0001.pgm')
image1=face
image2=face
print (face.shape)
...
def otsu_th():
  print("Universidad Politecnica Salesiana - Computacion Paralela\n")
  print("Jonathan Barrionuevo - Daniela Campoverded - Andres Loachamin")  
  print("Proceso de Binarizacion de Otsu.. Iniciando.\n")
  ...
  print("\nvalor del threshold = "+ str(threshold))
...
print("Tiempo de Ejecucion: "+str(b-a))
