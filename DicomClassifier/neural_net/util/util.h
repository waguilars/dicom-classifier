...
#include "neural_net/xtensor/xarray.hpp"
#include "neural_net/xtensor/xview.hpp"

#include "neural_net/config.h"

#ifndef CNN_NO_SERIALIZATION
#include <neural_net/cereal/archives/binary.hpp>
#include <neural_net/cereal/archives/json.hpp>
#include <neural_net/cereal/archives/portable_binary.hpp>
#include <neural_net/cereal/cereal.hpp>
#include <neural_net/cereal/types/deque.hpp>
#include <neural_net/cereal/types/polymorphic.hpp>
#include <neural_net/cereal/types/string.hpp>
#include <neural_net/cereal/types/vector.hpp>
#endif

#include "neural_net/util/aligned_allocator.h"
#include "neural_net/util/macro.h"
#include "neural_net/util/nn_error.h"
#include "neural_net/util/parallel_for.h"
#include "neural_net/util/product.h"
#include "neural_net/util/random.h"
